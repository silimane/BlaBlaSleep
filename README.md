...
pdf.multi_cell(0, 5, txt=index_html_content)

# Add a new page for styles.css
pdf.add_page()
pdf.set_font("Arial", 'B', 12)
pdf.cell(200, 10, txt="css/styles.css", ln=True)

# Add the styles.css content
styles_css_content = """
body {
...
"""
pdf.set_font("Arial", size=10)
pdf.multi_cell(0, 5, txt=styles_css_content)

# Add a new page for scripts.js
pdf.add_page()
pdf.set_font("Arial", 'B', 12)
pdf.cell(200, 10, txt="js/scripts.js", ln=True)

# Add the scripts.js content
scripts_js_content = """
...
/hotel1.jpg', title: 'Hotel 1', location: 'Paris', price: '$100/night' },
